 ...
 * Use the [KilometrikorvausFragment.newInstance] factory method to
...
class KilometrikorvausFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment KilometrikorvausFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KilometrikorvausFragment().apply {
